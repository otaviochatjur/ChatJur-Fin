...
export async function GET(request: Request) {
  try {
    ...
    const filters = [
      "select=id,subscription_id,payment_link_id,customer_id,asaas_payment_id,status,value,net_value,billing_type,due_date,payment_date,confirmed_date,refunded_at,created_at",
