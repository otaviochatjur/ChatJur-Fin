...
test("builds the selected recipient from Asaas and the internal customer status without reading Chat Jurídico payments", async () => {
  ...
  globalThis.fetch = async input => {
    ...
    if (url.pathname === "/rest/v1/customers") return Response.json([{ id: "customer-1", asaas_customer_id: "cus_1", status, phone: "11911112222", responsible_name: "Ana", office_name: "Ana Sociedade" }]);
