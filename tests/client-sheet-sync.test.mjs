...
test("reconciles changed client numbers, inserts complete rows and reports system-only emails", async () => {
  ...
  const customers = [
    { id: "customer-a", external_office_id: "10", office_name: "Nome antigo", responsible_name: "Ana", email: "ana@example.com", phone: null, city: null, state: null, service_area: null, source_channel: null, signed_at: null },
    { id: "customer-old", external_office_id: "99", office_name: "Fora da base", responsible_name: null, email: "fora@example.com", phone: null, city: null, state: null, service_area: null, source_channel: null, signed_at: "2025-01-01" },
  ];
  const audits = [];
